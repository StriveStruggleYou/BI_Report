...
var hui = (function(selector){
	...
	var hcExtends = {
		...
		swipeUp : function(callBack){
			if(this.length != 1){return;}
			if(this.swiper == null){this.swiper = new Hammer(this.dom[0]);}
			this.swiper.get('static.demo.swipe').set({direction: Hammer.DIRECTION_ALL});
